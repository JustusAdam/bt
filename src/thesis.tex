...
\faculty{\href{http://inf.tu-dresden.de}{Faculty for Comuter Science}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
In this thesis I expand on an idea implemented prior to this in the paper <paper> % TODO add paper
by generalizing its rewrite algorithms as well as providing more evidence for the efficiency achieved there with experiments.
...
\newcommand{\yauhauPaperTitle}{Consise code and efficient IO with Data Flow}
