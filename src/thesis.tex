...
The main focus is generalizing its rewrite algorithms to handle alternate flow of control as is present in mapping operations and conditionals.
In addition to that I will provide further evidence for the efficiency achieved in \yauhau{} by conducting experiments on randomly generated program graphs comparing perfomance with existing solutions.
To achieve a clean api in the ohua compiler there will also be considerations and implementation concerning % TODO <- bad word, find something better
the separation between functions and algorithms in the ohua DSL.
