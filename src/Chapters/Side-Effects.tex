...
% “similar situation to above” -> “similar situation as above”
% “there is not” -> “there is no”
% “This all sounds counter intuitive and it is.” -> this sounds negative. Ohua tries to do something new and thereby diverges from existing conventions. I think, this is required in order to address these multi-core issues.
% “However, we don’t …” This contradicts what you just said two sentences before when you argued that Ohua’s program semantics are counter intuitive and therefore a source of errors. -> The point is that seq would create the program semantics of a “normal” program and therewith break its efficiency by reducing opportunities to execute functions in parallel. (See the experiment in 11.1)
